            ...
            <div className="p-8 max-w-md w-full bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <Link to="/signup" className="mt-4 text-sm text-green-500 hover:text-green-800">
                            계정이 없으신가요? 회원가입
                        </Link>
                    </div>
                </form>
                <div className="mt-6">
                    ...
                    <div className="mt-6">
                        <a href="/oauth2/authorization/google" className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            {/* 구글 로고 SVG 아이콘 */}
